...
my_pipeline, pipeline_features_list, qstats, df_random, df_textbook, questions = get_data()
...
def plot_learning_curve(my_pipeline,
    ...
    return pd.Series(stats.mean(axis=0), name=f'{training_question_selection_strategy}')